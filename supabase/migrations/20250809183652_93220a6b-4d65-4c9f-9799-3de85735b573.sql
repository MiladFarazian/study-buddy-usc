-- Drop and recreate the badge functions

DROP FUNCTION IF EXISTS public.award_badges_for_tutor(uuid);

-- Create the fixed badge awarding function with correct founding tutor date
