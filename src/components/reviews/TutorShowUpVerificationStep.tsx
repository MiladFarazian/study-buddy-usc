...
interface TutorShowUpVerificationStepProps {
  student: Profile;
  session: Session;
  onResponse: (showedUp: boolean) => void;
}

export function TutorShowUpVerificationStep({
  student,
  session,
  onResponse
}: TutorShowUpVerificationStepProps) {
  return (
      ...
      <div className="text-center space-y-6">
        <div className="space-y-3">
          <h2 className="text-2xl font-bold text-foreground">
            Did your student show up for the scheduled session?
          </h2>
          <p className="text-muted-foreground text-lg">
            This helps us process payment and track session attendance.
          </p>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-left">
              ...
              <ul className="text-sm text-blue-700 space-y-1">
                <li>• Ensures fair payment processing for tutors</li>
                <li>• Helps track student attendance patterns</li>
                <li>• Allows us to address any scheduling issues</li>
              </ul>
            </div>
          </div>
        </div>
